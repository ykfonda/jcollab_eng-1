 ...
 */
	Configure::write('Session', array(
        ...
        'cookieTimeout' => 600, // The session cookie will live for at most 24 hours, this does not effect session timeouts
        'checkAgent' => false,
        'autoRegenerate' => false, // causes the session expiration time to reset on each page load
        'cookie' => 'JCOLLAB-APP', // select a different one for each app
	));
