...
(function($){
		...
		return this.each(function(){
			...
			*/
			nmpd.getValue = function(){
				return isNaN(nmpd.display.val()) ? 0 : parseFloat( nmpd.display.val() );
			};
	...
	*/
	...
	$.fn.numpad.defaults = {
		...
		rowTpl: '<tr></tr>',
		cellTpl: '<td></td>',
		buttonNumberTpl: '<button type="button" class="btn btn-default" style="width:100%;font-size: 15px;font-weight: bold;"></button>',
		buttonFunctionTpl: '<button type="button" class="btn btn-default" style="width:100%;font-size: 15px;font-weight: bold;"></button>',
		gridTableClass: '',
