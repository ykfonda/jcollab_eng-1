<div class="modal-header">
	...
	<h4 class="modal-title">
		<?php if ( isset($this->data['Decharchementdetail']['id']) ): ?>
			Modifier un article
		<?php else: ?>
			Ajouter un article
		<?php endif ?>
...
<?php echo $this->Form->create('Decharchementdetail',['id' => 'DecharchementdetailEditForm','class' => 'form-horizontal']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'DecharchementdetailEditForm','class' => 'saveBtn btn btn-success')) ?>
