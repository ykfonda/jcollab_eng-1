...
<?php $this->end() ?>
<div class="hr"></div>
<?php if ( isset( $this->data['Decharchement']['id'] ) AND !empty( $this->data['Decharchement']['id'] ) ): ?>
...
<div class="portlet light bordered">
  <div class="portlet-title">
    ...
    <div class="actions">
      <?php if ( isset( $this->data['Decharchement']['id'] ) AND $this->data['Decharchement']['etat'] == 1 ): ?>
        <a href="<?php echo $this->Html->url(['action'=>'changestate',$this->data['Decharchement']['id'],3 ]) ?>" class="changestate btn btn-danger btn-sm"><i class="fa fa-check-square-o"></i> Clôturer</a>
        <a href="<?php echo $this->Html->url(['action'=>'changestate',$this->data['Decharchement']['id'],2 ]) ?>" class="changestate btn btn-success btn-sm"><i class="fa fa-check-square-o"></i> Valider</a>
      <?php endif ?>
      <?php if ( isset( $this->data['Decharchement']['id'] ) AND $this->data['Decharchement']['etat'] == -1 ): ?>
        <a href="<?php echo $this->Html->url(['action'=>'changestate',$this->data['Decharchement']['id'],1 ]) ?>" class="changestate btn btn-warning btn-sm"><i class="fa fa-check-square-o"></i> Terminer la saisie</a>
      <?php endif ?>
          ...
          <table class="table table-bordered tableHeadInformation">
            <tbody>
              <tr>
                ...
                <td nowrap="">
                  <?php echo $this->data['Decharchement']['reference'] ?>
                </td>
                <td class="tableHead" nowrap="">Date</td>
                <td nowrap=""> 
                  <?php echo $this->data['Decharchement']['date'] ?>
                </td>
              </tr>
              <tr>
                ...
                <td nowrap="" >
                  <?php if ( !empty( $this->data['Decharchement']['etat'] ) ): ?>
                    <span class="badge badge-default" style="width: 100%;background-color: <?php echo $this->App->getEtatRetourColor($this->data['Decharchement']['etat']); ?>">
                      <?php echo $this->App->getEtatRetour($this->data['Decharchement']['etat']); ?>
                    </span>
                  <?php endif ?>
                </td>
              </tr>
...
<div class="portlet light bordered">
  <div class="portlet-title">
    ...
    <div class="actions">
      <?php if ( $globalPermission['Permission']['a'] AND isset( $this->data['Decharchement']['id'] ) AND $this->data['Decharchement']['etat'] == -1 ): ?>
        <a href="<?php echo $this->Html->url(['action' => 'editdetail',0,$this->data['Decharchement']['id']]) ?>" class="edit btn btn-primary btn-sm"><i class="fa fa-plus"></i> Ajouter produit</a>
      <?php endif ?>
    </div>
  </div>
  <div class="portlet-body">
          ...
          <table class="table table-striped table-bordered  table-hover" cellpadding="0" cellspacing="0">
            <thead>
              <tr>
                ...
                <?php if ( $this->data['Decharchement']['etat'] == -1 ): ?>
            ...
            <tbody>
              ...
              <?php foreach ($details as $tache): ?>
                <?php $total = $total + $tache['Decharchementdetail']['total']; ?>
                <?php $total_ttc = $total_ttc + $tache['Decharchementdetail']['ttc']; ?>
                <?php $total_qte = $total_qte + $tache['Decharchementdetail']['qte']; ?>
                <tr>
                  <td nowrap=""><?php echo h($tache['Produit']['libelle']); ?> </td>
                  <td nowrap=""><?php echo ( !empty( $tache['Decharchementdetail']['declaration'] ) ) ? $this->App->getDeclaration($tache['Decharchementdetail']['declaration']) : ''; ?></td>
                  <td nowrap=""><?php echo h($tache['Decharchementdetail']['qte']); ?></td>
                  <?php if ( $this->data['Decharchement']['etat'] == -1 ): ?>
                  <td nowrap="" class="actions">
                      <?php if ( $globalPermission['Permission']['m1'] ): ?>
                        <a href="<?php echo $this->Html->url(['action' => 'editdetail', $tache['Decharchementdetail']['id'], $tache['Decharchementdetail']['decharchement_id']]) ?>" class="edit"><i class="fa fa-edit"></i></a>
                      <?php endif ?>
                      <?php if ( $globalPermission['Permission']['s'] ): ?>
                        <a href="<?php echo $this->Html->url(['action' => 'deletedetail', $tache['Decharchementdetail']['id'], $tache['Decharchementdetail']['decharchement_id']]) ?>" class="btnFlagDelete"><i class="fa fa-trash-o"></i></a>
                      <?php endif ?>
                  </td>
                  <?php endif ?>
                </tr>
...
$(function(){
  ...
  var depot_id = <?php echo ( isset( $this->data['User']['depot_id'] ) AND !empty( $this->data['User']['depot_id'] ) ) ? (int) $this->data['User']['depot_id'] : 1 ; ?>;

  function getProduit(produit_id,categorieclient_id) {
    $.ajax({
      dataType:'JSON',
      url: "<?php echo $this->Html->url(['action' => 'getProduit']) ?>/"+produit_id+'/'+categorieclient_id+'/'+depot_id,
      success: function(dt){
  ...
  function loadproduits(categorieproduit_id,depot_id) {
    $.ajax({
      dataType: "json",
      url: "<?php echo $this->Html->url(['action' => 'loadproduits',$this->data['Decharchement']['id'] ]) ?>/"+categorieproduit_id+'/'+depot_id,
      success: function(dt){
