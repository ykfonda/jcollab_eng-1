...
<div class="portlet light bordered">
    ...
    <div class="row">
      ...
      <div class="formFilter">
        <?php $base_url = array('controller' => 'fournisseurs', 'action' => 'indexAjax'); ?>
        ...
        <div class="col-md-12 smallForm">
          <div class="form-group row">
            <div class="col-md-3">
              <?php echo $this->Form->input('Filter.Fournisseur.libelle',array('label'=>false,'placeholder'=>'Désignation','class'=>'form-control')) ?>
            </div>
            <div class="col-md-3">
