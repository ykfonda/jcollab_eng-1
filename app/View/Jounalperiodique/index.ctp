    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="formFilter">
          <?php $base_url = array('controller' => $this->params['controller'], 'action' => 'index'); ?>
          <?php echo $this->Form->create("Filter",array('url' => $base_url, 'class' => 'form-horizontal')) ?>
            <div class="form-group row" style="margin-top: 15px;">
              <div class="col-lg-3">
                  <div class="d-flex align-items-end">
                    <?php echo $this->Form->input('Filter.Bonlivraison.date1',array('label' => false,'placeholder' => 'Date 1','class' => 'date-picker form-control','required'=>true,'type'=>'text','data-default-date'=>date('d-m-Y'))) ?>
                      <span class="input-group-addon">&nbsp;à&nbsp;</span>
                    <?php echo $this->Form->input('Filter.Bonlivraison.date2',array('label' => false,'placeholder' => 'Date 2','class' => 'date-picker form-control','required'=>true,'type'=>'text','data-default-date'=>date('d-m-Y'))) ?>
                  </div>
                </div>
              <div class="col-lg-3">
