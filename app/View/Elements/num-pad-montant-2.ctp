...
$(function() {
    ...
    let _element = "#Montant2";
    let _container = "#Mode2Container";
    let _btnNumber = ".numberClickMode2";
    let _btnDelete = ".easy_numpad_del_mode2";
    let _btnClear = ".easy_numpad_clear_mode2";
