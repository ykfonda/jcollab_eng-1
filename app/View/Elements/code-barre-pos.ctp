...
let _output = "<?php echo $output ?>";
let _element = "<?php echo $element ?>";
...
$(document).on('click','.index_numpad_done',function(e) {
    e.preventDefault();
    let index_numpad_output_val = $(".easy-numpad-output").html();
    $(_element).val(index_numpad_output_val);
...
function show_index_numpad(thisElement){
            ...
            <div class="easy-numpad-number-container">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td/><button class="btn btn-success btn-block btn-lg index_numpad_done" type="button"><i class="fa fa-check"></i> Terminer</button><td>
                    </tr>
                </table>
            </div>
        </div>
