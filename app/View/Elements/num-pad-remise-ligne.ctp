...
$(function() {
    ...
    let _element = "#RemiseArticle";
    let _container = "#RemiseLigneContainer";
    let _btnNumber = ".numberClickRemiseArticle";
    let _btnDelete = ".easy_numpad_del_remise_article";
    let _btnClear = ".easy_numpad_clear_remise_article";
    ...
    $('#edit').on('click',_btnNumber,function(e) {
        ...
        console.log('_elementValue : ',_elementValue)
