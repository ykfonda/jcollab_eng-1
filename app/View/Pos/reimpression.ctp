					...
					<table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0">
						...
						<tbody>
							<?php foreach ($salepoints as $dossier): ?>
								<tr>
									<td nowrap=""><a class="traitercommande btn btn-danger btn-sm btn-block" href="<?php echo $this->Html->url(['action'=>'impression',$dossier['Salepoint']['id']]) ?>"><i class="fa fa-reply"></i> Impression</a></td>
									...
									<td nowrap="" class="actions">
										<a class="getdetail btn btn-primary btn-sm btn-block" href="<?php echo $this->Html->url(['controller' => "Salepoints",'action'=>'SaisirClient',$dossier['Salepoint']['id'],$dossier['Salepoint']['client_id']]) ?>"><i class="fa fa-eye"></i> Facture</a>
									</td>
                                    <td nowrap="" class="actions">
