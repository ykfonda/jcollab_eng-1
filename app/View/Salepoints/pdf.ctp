...
$MT_TVA=$this->data['Salepoint']['montant_tva']+($this->data['Salepoint']['fee']*0.2/1.2);
$MT_HT=$MT_TTC-$MT_TVA;
...
<br><br><br>
  ...
  <tbody>
    ...
    <div class="rounded">
        ...
        <table  class="details" width="100%" style="border:100%">
            <thead>
                <tr>
            ...
            <tbody>';
                foreach ($details as $tache) {
                    $html .= '<tr>
                        ...
                        <td nowrap style="text-align:right;border:0px">'.(int) $tache['Produit']['tva_vente'].'%</td>
                ...
                <div style="position : relative; float : left; margin-left : 0.9rem">
                        <h3 style="width:50%;text-align:left;font-size : 90%;">
                            Arrêtée la présente de Facture à la somme de :
                        </h3>
