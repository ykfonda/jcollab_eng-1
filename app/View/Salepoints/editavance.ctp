...
<?php echo $this->Form->create('Avance',['id' => 'AvanceEditForm','class' => 'form-horizontal']); ?>
	<div class="row">
		...
		<?php else: ?>
			<div class="col-md-12">
				<div class="p-2 alert alert-info text-center" role="alert">
				  <strong> Le reste à payer est <?php echo number_format($reste_a_payer, 2, ',', ' '); ?> </strong>
				</div>
			</div>
			<div class="col-md-12">
				<div class="p-2 alert alert-info text-center" id="Loading" style="margin-bottom:5px;display: none;">
				...
				<div class="form-group row">
					...
					<div class="col-md-3">
						<?php echo $this->Form->input('montant',['class'=>'form-control','label'=>false,'required'=>true,'min'=>0,'max'=>$reste_a_payer,'default'=>$reste_a_payer]); ?>
					</div>
				</div>
				<div class="form-group row">
