...
<?php echo $this->Form->create('Date',array('id' => 'RangeDate')); ?>
	<?php echo $this->Form->hidden('start',['value' => $date['start'], 'id' => 'RangeDateStart']); ?>
	<?php echo $this->Form->hidden('end',['value' => $date['end'], 'id' => 'RangeDateEnd']); ?>
	<input type="text" name="typeSubmit" value="RangeDate">
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header">
              <h4 class="card-title">Crédits restants</h4>
              <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <!-- li actions -->
                  </ul>
                        ...
                        <div class="col-md-12" style="max-height: 350px;overflow-y: scroll;">
                            <div class="table-scrollable" style="height: 300px;">
                                <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($soldes as $dossier): ?>
                                            <tr>
                                                <td nowrap="">
                                                    <a target="_blank" href="<?php echo $this->Html->url(['controller'=>'clients','action'=>'view',$dossier['Client']['id']]) ?>"><?php echo h($dossier['Client']['designation']); ?></a>
                                                </td>
                                                <td nowrap="" class="text-right">
                                                    <?php $reste_a_payer = ( isset( $dossier[0]['reste_a_payer'] ) ) ? $dossier[0]['reste_a_payer'] : 0; ?>
                                                    <?php echo number_format($reste_a_payer, 2, ',', ' ') ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
...
<?php $this->end() ?>
 ...
 <!--------
    ...
    <div class="card">
            <div class="card-header">
              <h4 class="card-title">Tickets en double</h4>
              <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <!-- li actions -->
                  </ul>
                        ...
                        <div class="col-md-12" style="max-height: 350px;overflow-y: scroll;">
                            <div class="table-scrollable" style="height: 300px;">
                                <table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($results_double_tickets as $dossier): ?>
                                            <tr>
                                                <td nowrap="">
                                                    <?php echo h($dossier['Salepoint']['numero_ticket']); ?>
                                                </td>
                                                <td nowrap="">
                                                    <?php echo h($dossier['Salepoint']['montant_ticket']); ?>
                                                </td>
                                                <td nowrap="">
                                                    <?php echo h($dossier[0]['date']); ?>
                                                </td>
                                                <td nowrap="">
                                                    <?php echo h($dossier[0]['heure_ticket']); ?>
                                                </td>
                                                <td nowrap="">
                                                    <?php echo h($dossier['Store']['store_libelle']); ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
