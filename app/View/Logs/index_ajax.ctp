<div class="table-responsive" style="min-height: auto;">
	<table class="table table-striped table-bordered  table-hover" cellpadding="0" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				<td><?php echo h($log['Loging']['module']); ?>&nbsp;</td>
				<td><?php echo h($log['Loging']['transaction']); ?>&nbsp;</td>
				<td><?php echo h($log['User']['nom'].' '.$log['User']['prenom']); ?>&nbsp;</td>
				<td><?php echo h($log['Loging']['date_c']); ?>&nbsp;</td>
			</tr>
			<?php endforeach; ?>
		</tbody>
	</table>
