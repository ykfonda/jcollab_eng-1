<div class="modal-header">
	<h4 class="modal-title">
		<?php if ( isset($this->data['Ecommerce']['id']) ): ?>
...
<?php echo $this->Form->create('Ecommerce',['id' => 'EcommerceEditForm','class' => 'form-horizontal','autocomplete'=>'off']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'EcommerceEditForm','class' => 'saveBtn btn btn-success')) ?>
