...
<body>
    <div class="container">
        ...
        <table class="info" width="100%">
            <tbody>
                <tr>
                    <td width="50%">VENTE N° : '.$this->data['Vente']['reference'].'</td>
        ...
        <table class="info data" width="100%">
            ...
            <tbody>';
                ...
                foreach ($details as $tache){
                    ...
                    $total_tva = $total_tva + $tache['Ventedetail']['ttc'] * (1 + (float)$tache['Produit']['tva']/ 100);
                    $html.='<tr>
...
//echo $html;die;
$pdfName = 'Vente.'.$this->data['Vente']['date'].'.pdf';
$dompdf = new DOMPDF();
