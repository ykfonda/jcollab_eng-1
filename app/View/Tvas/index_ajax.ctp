	...
	<table class="table table-striped table-bordered  table-hover" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				...
				<th nowrap="">Valeur</th>
				<th nowrap="">TVA sur Achat</th>
				<th nowrap="">TVA sur Vente</th>
		...
		<tbody>
			<?php foreach ($taches as $tache): ?>
				<tr>
					<td nowrap=""><?php echo h($tache['Tva']['reference']); ?></td>
					<td nowrap=""><?php echo h($tache['Tva']['libelle']); ?></td>
					<td nowrap=""><?php echo h($tache['Tva']['valeur']); ?></td>
					<td nowrap=""><?php echo h($tache['Tva']['achat']); ?></td>
					<td nowrap=""><?php echo h($tache['Tva']['vente']); ?></td>
					<td nowrap=""><?php echo h($tache['Tva']['date_c']); ?></td>
					<td nowrap="" class="actions">
						<?php if ($globalPermission['Permission']['m1']): ?>
							<a href="<?php echo $this->Html->url(['action' => 'edit', $tache['Tva']['id']]) ?>" class="edit"><i class="fa fa-edit"></i></a>
						<?php endif ?>
						<?php if ($globalPermission['Permission']['s'] ): ?>
							<a href="<?php echo $this->Html->url(['action' => 'delete', $tache['Tva']['id']]) ?>" class="btnFlagDelete"><i class="fa fa-trash-o"></i></a>
						<?php endif ?>
					</td>
				</tr>
			<?php endforeach; ?>
