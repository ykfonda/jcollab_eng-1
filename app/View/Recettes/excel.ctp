...
$objPHPExcel->getProperties()->setCreator("WebCRM")->setLastModifiedBy("WebCRM")->setTitle("Recettes");
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E'.$headTable, 'Prix d\'achat TTC')
...
$objPHPExcel->getActiveSheet()->setTitle('Recettes');
...
header('Content-Disposition: attachment;filename="Recettes.xls"');
