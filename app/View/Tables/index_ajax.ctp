	...
	<table class="table table-striped table-bordered  table-hover" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				...
				<th nowrap="">Nom ou numéro de table</th>
				<th nowrap="">Nombre d'occupants</th>
		...
		<tbody>
			<?php foreach ($taches as $tache): ?>
				<tr>
					<td nowrap=""><?php echo h($tache['Table']['reference']); ?></td>
					<td nowrap=""><?php echo h($tache['Table']['libelle']); ?></td>
					<td nowrap="" class="text-right"><?php echo h($tache['Table']['nbr_persons']); ?> personne(s)</td>
					<td nowrap=""><?php echo h($tache['Table']['date_c']); ?></td>
					<td nowrap="" class="actions">
						<?php if ($globalPermission['Permission']['m1']): ?>
							<a href="<?php echo $this->Html->url(['action' => 'edit', $tache['Table']['id']]) ?>" class="edit"><i class="fa fa-edit"></i></a>
						<?php endif ?>
						<?php if ($globalPermission['Permission']['s'] ): ?>
							<a href="<?php echo $this->Html->url(['action' => 'delete', $tache['Table']['id']]) ?>" class="btnFlagDelete"><i class="fa fa-trash-o"></i></a>
						<?php endif ?>
					</td>
				</tr>
			<?php endforeach; ?>
