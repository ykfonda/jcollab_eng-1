<div class="modal-header">
	...
	<h4 class="modal-title">
		<?php if ( isset($this->data['Facturedetail']['id']) ): ?>
			Modifier un produit
		<?php else: ?>
			Ajouter un produit
		<?php endif ?>
...
<?php echo $this->Form->create('Bonlivraisondetail',['id' => 'ScanForm','class' => 'form-horizontal','autocomplete'=>'off']); ?>
	...
	<?php echo $this->Form->create('Facturedetail',['id' => 'FacturedetailEditForm','class' => 'form-horizontal']); ?>
		<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'FacturedetailEditForm','class' => 'saveBtn btn btn-success')) ?>
