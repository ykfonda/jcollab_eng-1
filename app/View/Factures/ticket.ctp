<html>
    <head>
    	<title>FACTURE N° : <?php echo $this->data['Facture']['reference'] ?></title>
    ...
    <body>
        ...
        <div id='printbox'>
            ...
            <?php echo $this->element('header-ticket',['societe' => $societe,'title' => 'FACTURE']) ?>
            
            <div class="line">
                FACTURE N° : <?php echo $this->data['Facture']['reference'] ?>
            </div>
            ...
            <table id="products" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td nowrap=""><?php echo $tache['Facturedetail']['qte'] ?></td>
                    <td style="text-align: left;"><?php echo $this->Text->truncate($tache['Produit']['libelle'], 25) ?></td>
                    <td nowrap="" style="text-align: right;"><?php echo number_format($tache['Facturedetail']['prix_vente'], 2, ',', ' ') ?></td>
                    <td nowrap="" style="text-align: right;"><?php echo (int)$tache['Facturedetail']['remise'] ?>%</td>
                    <td nowrap="" style="text-align: right;"><?php echo number_format($tache['Facturedetail']['total'], 2, ',', ' ') ?></td>
                </tr>
                <?php endforeach ?>
            </table><br/>

            <p style="text-align: right;margin-top: 2px;padding-bottom: 2px;font-weight: bold;"> 
                NET A PAYER : <?php echo number_format($this->data['Facture']['total_apres_reduction'], 2, ',', ' ') ?>
            </p>
