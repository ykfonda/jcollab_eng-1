...
<div class="portlet light bordered">
	<div class="portlet-title">
		...
		<div class="actions">
			...
			<?php echo $this->Form->button('Valider & Terminer',['class'=>'btn btn-success saveBtn','type'=>'submit','form' => 'MouvementSortie','disabled'=>true]) ?>
		</div>
	</div>
	...
	function loadproduit(produit_id,depot_id,element) {
		$.ajax({
		  ...
		  success: function(dt){
		   ...
		   /*  if ( typeof dt.data != 'undefined' && typeof dt.data.id != 'undefined' ) { */
