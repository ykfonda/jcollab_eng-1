<div class="modal-header">
	...
	<h4 class="modal-title">
		<?php if ( isset($this->data['Bonavoir']['id']) ): ?>
			Modifier un avoir
		<?php else: ?>
			Nouveau avoir
		<?php endif ?>
...
<?php echo $this->Form->create('Bonavoir',['id' => 'BonavoirEditForm','class' => 'form-horizontal','autocomplete'=>'off']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'BonavoirEditForm','class' => 'saveBtn btn btn-success')) ?>
