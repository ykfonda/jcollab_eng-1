...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			 Ventes comptables Consolidées par caisse 
		</div>
		<div class="actions">
      ...
      <div class="formFilter">
        ...
        <div class="col-md-12 smallForm">
          <div class="form-group row">
            <div class="col-md-3">
              <?php echo $this->Form->input('Filter.Salepoint3.magasin_id',array('label'=>false,'empty'=>'--Tout les magasins','placeholder'=>'Référence','class'=>'form-control select2')) ?>
            </div>
            <div class="col-md-2">
            <?php echo $this->Form->input('Filter.Salepoint3.date1',array('label' => false,'placeholder' => 'Date 1','class' => 'date-picker form-control','type'=>'text')) ?>
            </div>
            
            <div class="col-md-2">
            <?php echo $this->Form->input('Filter.Salepoint3.date2',array('label' => false,'placeholder' => 'Date 2','class' => 'date-picker form-control','type'=>'text')) ?>            </div>
