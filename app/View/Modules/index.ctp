...
<div class="modal fade" id="AddModule" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
		<?php echo $this->Form->create('Module',array('action' => 'add')); ?>
			...
			<?php
			  echo $this->Form->input('parent_id',array('label' => false,'empty' => '--Module','options' => $treeModule,'class' => 'select2 form-control')).'<br>';
			  echo $this->Form->input('libelle',array('label' => false,'placeholder' => 'Libelle','class' => 'form-control','required' => true)).'<br>';
			  echo $this->Form->input('niveau',array('type' => 'hidden','placeholder' => 'Niveau','class' => 'form-control','value' => 1));
			  echo $this->Form->input('link',array('label' => false,'placeholder' => 'Link','class' => 'form-control'));
			?>
			<div>
				<br/>
				<select class="select2 form-control" name="data[Module][icon]" style="font-family: 'FontAwesome', 'sans-serif';">
			...
			<div class="modal-footer">
				<button type="submit" class="btn blue">Enregister</button>
...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-comments"></i>Liste des modules
		</div>
		<div class="actions">
			<a href="<?php echo $this->Html->url(['action' => 'verifyByBoth']) ?>" data-toggle="modal" class="btn btn-primary btn-sm">
			<i class="fa fa-check"></i> Corriger </a>
			<!-- <a href="<?php echo $this->Html->url(['action' => 'verifyByParent']) ?>" data-toggle="modal" class="btn btn-primary btn-sm">
			<i class="fa fa-check"></i> Corriger (Parent) </a> -->
			<a href="#AddModule" data-toggle="modal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Ajouter </a>
		</div>
	</div>
		...
		<div class="table-scrollable">
			<table class="table table-striped table-bordered  table-hover" cellpadding="0" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						<?php if (!isset($module['ParentModule']['id']) || empty($module['ParentModule']['id'])): ?>	
							<td style="color: #000; font-weight: 700"><?php echo $treeModule[$module['Module']['id']]; ?>&nbsp;</td>
						<?php else: ?>
							<td><?php echo $treeModule[$module['Module']['id']]; ?>&nbsp;</td>
						<?php endif ?>
						<td nowrap="">
							<a href="<?php echo $this->Html->url(array('controller' => 'modules','action' => 'moveup',$module['Module']['id'])) ?>" class="ajax"><i class="fa fa-chevron-up"></i></a>
							&nbsp;
							<a href="<?php echo $this->Html->url(array('controller' => 'modules','action' => 'movedown',$module['Module']['id'])) ?>" class="ajax"><i class="fa fa-chevron-down"></i></a>
						</td>
						<td nowrap=""><?php echo $module['ParentModule']['libelle']; ?></td>
						<td nowrap=""><?php echo h($module['Module']['created']); ?>&nbsp;</td>
						<td nowrap=""><i class="fa <?php echo $module['Module']['icon']; ?>"></i></td>
						<td class="actions">
							<?php echo $this->Html->link(__('Modifier'), array('action' => 'edit', $module['Module']['id'])); ?>
							<?php echo $this->Html->link(__('Supprimer'), array('action' => 'delete', $module['Module']['id']),array('class' => 'deleteBtn','data-message' => "Vous êtes sur que vous voulez supprimer {$module['Module']['libelle']} ?")); ?>
						</td>
					</tr>
					<?php endforeach; ?>
				</tbody>
