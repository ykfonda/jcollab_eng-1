<?php $this->assign('title','Modifier le Module') ?>
<style type="text/css">
	select {
	...
	<div class="row">
	  <div class="col-md-8 col-md-push-2">
		<?php
			...
			echo $this->Form->input('parent_id',array('empty' => '--Module','options' => $parentModules,'class' => 'select2 form-control'));
			echo $this->Form->input('libelle',array('class' => 'form-control'));
			echo $this->Form->input('niveau',array('type' => 'hidden','value'=>1));
			echo $this->Form->input('link',array('class' => 'form-control'));
		?>
		<br/>
		<select class="form-control" name="data[Module][icon]">
		...
		<br>
		<?php echo $this->Form->submit('Enregister',array('class' => 'btn btn-primary')) ?>
	  </div>
	</div>
