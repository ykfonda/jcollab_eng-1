<div class="table-scrollable" style="height: auto;">
	<table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				...
				<th nowrap="">Caisse</th>
				<th nowrap="">Caissier(e)</th>
				<th nowrap="">Date</th>
				<th nowrap="">Especes</th>
				<th nowrap="">FdCaisse</th>
    ...
    font-weight: 500;">
				...
				<td nowrap=""><?php echo h ($dossier[0]['caisse']) ?></td>
				<td nowrap=""><?php echo h ($dossier[0]['nom'] . " ". $dossier[0]['prenom']) ; ?></td>

				<?php
					$dateString = $dossier[0]['datec'];
					$timestamp = strtotime($dateString);
					$dateFormatted = date('d-m-Y', $timestamp);
				?>

				<td nowrap=""><?php echo $dateFormatted ?></td>
				<td nowrap="" class="text-right total_number"><?php echo h (!empty($dossier[0]['Especes'])) ? (number_format($dossier[0]['Especes'],2, ',', ' ')) :  "0.00" ?></td>
				<td nowrap="" class="text-right total_number"><?php echo h (!empty($dossier[0]['T09'])) ? (number_format($dossier[0]['T09'],2,","," ")) :  "0.00" ?></td>
		          ...
		          <table class="table table-bordered tableHeadInformation">
		            <tbody>
		              ...
		              <tr>
		                ...
		                <td nowrap="" colspan="3" class="text-right total_number"> 
						...
						<td class="tableHead" nowrap="">FdCaisse</td>
		                <td nowrap="" class="text-right total_number">
		                  <?php echo number_format($T09,2,","," ") ?>
		                </td>
		              </tr>
		              <tr>
		              ...
		              <tr>
		                ...
		                <td colspan="3" class="text-right total_number">
		              ...
		              <tr>						
						...
						<td class="tableHead" nowrap="">Montant Annulés</td>
		                <td class="text-right total_number">
