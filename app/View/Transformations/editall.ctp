...
<div class="card">
  <div class="card-header">
      <h4 class="card-title">Transformation en masse</h4>
      <div class="heading-elements">
          <ul class="list-inline mb-0">
              <li>
								<a href="<?php echo $this->Html->url(['action' => 'index']) ?>" class="btn btn-primary btn-sm"><i class="fa fa-reply"></i> Vers la liste </a>
								<?php echo $this->Form->button('Enregistrer & Terminer',['class'=>'btn btn-success saveBtn','type'=>'submit','form' => 'TransformationMasse','disabled'=>false]) ?>
              </li>
          </ul>
      </div>
  </div>
  <div class="card-content collapse show">
    <div class="card-body">
      <div class="row">
				<div class="col-md-12">
					<?php echo $this->Form->create('Transformation',['id' => 'TransformationMasse','class' => 'form-horizontal']); ?>
					...
					<div class="form-group row row">
		          	...
		          	<thead>
		              <tr>
		                  <th nowrap="" style="width: 30%;">Produit à transformer</th>
		                  <th nowrap="" style="width: 10%;">Quantité</th>
		                  <th nowrap="" style="width: 30%;">Produit transformé</th>
		                  <th nowrap="" style="width: 10%;">Quantité</th>
		                  <th nowrap="" style="width: 10%;" class="actions">
...
$(function(){
  ...
  $('.date-picker').flatpickr({
	...
	$('#TransformationMasse').on('submit',function(e){
