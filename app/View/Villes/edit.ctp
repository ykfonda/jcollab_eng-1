...
<?php echo $this->Form->create('Ville',['id' => 'VilleEditForm','class' => 'form-horizontal']); ?>
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="form-group row">
				...
				<div class="col-md-8">
					<?php echo $this->Form->input('pay_id',['class' => 'form-control','label'=>false,'required' => true,'empty'=>'--Pays']); ?>
				</div>
			</div>
		</div>
	</div>
