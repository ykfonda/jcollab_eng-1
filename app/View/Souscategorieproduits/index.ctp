...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			Liste des sous catégories produit
		</div>
		<div class="actions">
    ...
    <div class="row">
      ...
      <div class="formFilter">
        <?php $base_url = array('controller' => 'souscategorieproduits', 'action' => 'indexAjax'); ?>
        ...
        <div class="col-md-12 smallForm">
          <div class="form-group row">
            <div class="col-md-3">
              <?php echo $this->Form->input('Filter.Souscategorieproduit.libelle',array('label'=>false,'placeholder'=>'Libelle','class'=>'form-control')) ?>
            </div>
            <div class="col-md-3">
              <?php echo $this->Form->input('Filter.Souscategorieproduit.categorieproduit_id',array('label'=>false,'empty'=>'-- Catégorie','class'=>'form-control')) ?>
            </div>
            <div class="col-md-3">
