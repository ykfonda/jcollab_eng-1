<div class="modal-header">	
	<h4 class="modal-title">
		<?php if ( isset($this->data['Commandeglovodetail']['id']) ): ?>
			Modifier un produit
		<?php else: ?>
			Ajouter un produit
		<?php endif ?>
...
<?php echo $this->Form->create('Commandeglovodetail',['id' => 'CommandeglovodetailEditForm','class' => 'form-horizontal']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'CommandeglovodetailEditForm','class' => 'saveBtn btn btn-success')) ?>
