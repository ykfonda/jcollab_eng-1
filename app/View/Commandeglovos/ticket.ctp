<html>
    <head>
        <title>COMMANDE N° : <?php echo $this->data['Commandeglovo']['order_code'] ?></title>
    ...
    <body>
        ...
        <div id='printbox'>
            ...
            <div class="line">
                COMMANDE N° : <?php echo $this->data['Commandeglovo']['order_code'] ?>
            </div>
            ...
            <table id="products" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td nowrap=""><?php echo $tache['Commandeglovodetail']['qte'] ?></td>
                    <td nowrap="" style="text-align: left;"><?php echo $this->Text->truncate($tache['Produit']['libelle'], 15) ?></td>
                    <td nowrap="" style="text-align: right;"><?php echo number_format($tache['Commandeglovodetail']['prix_vente'], 2, ',', ' ') ?></td>
                    <td nowrap="" style="text-align: right;"><?php echo number_format($tache['Commandeglovodetail']['total'], 2, ',', ' ') ?></td>
                </tr>
                <?php endforeach ?>
            </table><br/>

            <p style="text-align: right;margin-top: 2px;padding-bottom: 2px;font-weight: bold;"> 
                NET A PAYER : <?php echo number_format($this->data['Commandeglovo']['total_apres_reduction'], 2, ',', ' ') ?>
            </p>
