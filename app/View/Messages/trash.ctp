...
<!-- 			<li class="draft">
	...
	<div class="col-md-10">
		<div class="inbox-header">
			<h1 class="pull-left">Corbeille</h1>
...
<?php $userSession = $this->Session->read('Auth.User.id') ?>
<?php foreach ($messages as $key => $message): ?>
	<?php //if ( ($message['Message']['from_id'] == $userSession && $message['Message']['isread'] == '0') || ($message['MessagesUser']['user_id'] == $userSession && $message['MessagesUser']['isread'] == '0') ): ?>
