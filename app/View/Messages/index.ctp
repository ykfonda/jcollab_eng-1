...
<!-- 			<li class="draft">
	...
	<div class="col-md-10">
		<div class="inbox-header">
			<h1 class="pull-left">Boîte de réception</h1>
			<?php echo $this->Form->create("Filter",array('class' => 'form-inline pull-right')) ?>
				<div class="input-group input-medium">
				<?php echo $this->Form->input('Filter.keyword',['label' => false ,'class' => 'form-control']) ?>
...
<?php foreach ($messages as $key => $message): ?>
	<?php if ($message['MessagesUser']['isread'] == '0'): ?>
