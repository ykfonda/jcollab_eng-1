<div class="modal-header">
	<h4 class="modal-title">
		<?php if ( isset($this->data['Commande']['id']) ): ?>
...
<?php echo $this->Form->create('Commande',['id' => 'CommandeEditForm','class' => 'form-horizontal','autocomplete'=>'off']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'CommandeEditForm','class' => 'saveBtn btn btn-success')) ?>
