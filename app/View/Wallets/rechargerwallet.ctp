	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="form-group row">
				...
				<div class="col-md-3">
					<?php echo $this->Form->input('client', ['class' => 'form-control', 'label' => false, 'required' => true, 'readonly' => true]); ?>
				</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-3">
					<?php echo $this->Form->input('num_cheque', ['class' => 'form-control', 'label' => false, 'type' => 'text']); ?>
				</div>
			</div>
