...
$ressource = fopen($parent_dir.'ipAdresses/Caisse/caisses.txt', 'rb');

$ipAddress = fgets($ressource, 30);
		...
		<tbody>
			<?php foreach ($taches as $tache): ?>
				<tr>
                    ...
                    if ($ipAddress == $caisse_adresse_ip/* in_array($caisse_adresse_ip, $ipAddress) */) {
                        ?>
						<a class="ChooseCaisse" href="<?php echo Router::url(['controller' => 'Pos', 'action' => 'index', 0, $tache['Caisse']['id']]); ?>" style="color : #325ca7"> Choisir </a>
					<?php
                    } else {
                        ?>
