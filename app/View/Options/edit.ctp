<div class="modal-header">
	...
	<h4 class="modal-title">
		<?php if ( isset($this->data['Option']['id']) ): ?>
			Modifier Option
		<?php else: ?>
			Ajouter Option
		<?php endif ?>
...
<div class="modal-body ">
	<?php echo $this->Form->create('Option', ['id' => 'OptionEditForm']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer', array('div' => false,'form' => 'OptionEditForm','class' => 'saveBtn btn btn-success')) ?>
