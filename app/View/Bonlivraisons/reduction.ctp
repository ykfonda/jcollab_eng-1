	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-3">
					<?php $reste_a_payer = (isset( $this->data['Bonlivraison']['reste_a_payer'] )) ? $this->data['Bonlivraison']['reste_a_payer'] : '' ; ?>
					<?php $total_a_payer_ht = (isset( $this->data['Bonlivraison']['total_a_payer_ht'] )) ? $this->data['Bonlivraison']['total_a_payer_ht'] : '' ; ?>
