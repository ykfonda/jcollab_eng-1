<html>
    ...
    <body>
        ...
        <div id='printbox'>
            ...
            <div class="line">
                JOURNAL DU VENTE DU : <?php echo date('d-m-Y') ?>
            </div>
            ...
            <table id="products" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><?php echo $tache['Client']['designation'] ?></td>
            ...
            <table id="products" cellspacing="0" cellpadding="0" >
                ...
                <?php $total_retour = 0; ?>
                <?php foreach ($retours as $tache): ?>
                <?php $total_retour = $total_retour+$tache['Bonretour']['total_apres_reduction']; ?>
                <tr>
                    <td nowrap="" style="text-align: left;"><?php echo $tache['Bonretour']['reference'] ?></td>
                    <td style="text-align: left;"><?php echo $tache['Client']['designation'] ; ?></td>
                    <td nowrap="" style="text-align: right;"><?php echo number_format($tache['Bonretour']['total_apres_reduction'], 2, ',', ' ') ?></td>
                </tr>
                <?php endforeach ?>
            </table><br/>
            ...
            <table id="products" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                    <td>Total des retours</td>
                    <td><?php echo number_format($total_retour, 2, ',', ' ') ?></td>
                </tr>
            </table><br/>
