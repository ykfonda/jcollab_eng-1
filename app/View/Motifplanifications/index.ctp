...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			Liste des motifs planification
		</div>
		<div class="actions">
    ...
    <div class="row">
      ...
      <div class="formFilter">
        <?php $base_url = array('controller' => 'motifplanifications', 'action' => 'indexAjax'); ?>
        ...
        <div class="col-md-12 smallForm">
          <div class="form-group row">
            <div class="col-md-3">
              <?php echo $this->Form->input('Filter.Motifplanification.libelle',array('label'=>false,'placeholder'=>'Libelle','class'=>'form-control')) ?>
            </div>
            <div class="col-md-3">
