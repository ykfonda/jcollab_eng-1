...
<div class="portlet light bordered">
    ...
    <div class="row">
      ...
      <div class="formFilter">
        <?php $base_url = array('controller' => 'admins', 'action' => 'indexAjax'); ?>
        ...
        <div class="col-md-12 smallForm">
          <div class="form-group row">
            <div class="col-md-3">
              <?php echo $this->Form->input('Filter.Admin.role_id',array('label'=>false,'empty'=>'--Role','class'=>'select2 form-control')) ?>
            </div>
            <div class="col-md-3">
