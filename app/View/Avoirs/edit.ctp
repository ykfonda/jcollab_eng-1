<div class="modal-header">
	...
	<h4 class="modal-title">
		<?php if ( isset($this->data['Retour']['id']) ): ?>
			Modifier un retour
		<?php else: ?>
			Saisir un retour
		<?php endif ?>
...
<?php echo $this->Form->create('Retour',['id' => 'RetourEditForm','class' => 'form-horizontal','autocomplete'=>'off']); ?>
	<div class="row">
...
<div class="modal-footer">
	<?php echo $this->Form->submit('Enregistrer',array('div' => false,'form' => 'RetourEditForm','class' => 'saveBtn btn btn-success')) ?>
